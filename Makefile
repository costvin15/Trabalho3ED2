...
all: linker
linker: $(OBJ_DIR)linkedlist.o $(OBJ_DIR)queue.o $(OBJ_DIR)menu.o $(OBJ_DIR)utils.o $(OBJ_DIR)graphadjacencymatrix.o $(OBJ_DIR)main.o
	gcc -o main $(OBJ_DIR)linkedlist.o $(OBJ_DIR)queue.o $(OBJ_DIR)menu.o $(OBJ_DIR)utils.o $(OBJ_DIR)graphadjacencymatrix.o $(OBJ_DIR)main.o
